...
const Footer = () => {
  const services = [
    { name: "Match Making", path: "/service/match-making" },
    { name: "Parichay Sammelan Management", path: "/service/parichay-sammelan" },
    { name: "White Collar Matrimony Site/App", path: "/service/white-collar" },
    { name: "Assistance Match Making", path: "/service/assistance-match-making" },
    { name: "Marriage Biodata Maker", path: "/service/biodata-maker" },
    { name: "Premium & VIP Rishte", path: "/service/vip-rishte" },
    { name: "Vivah Management", path: "/service/vivah-management" },
    { name: "Kundali Milan", path: "/service/kundali-milan" },
    { name: "Vivah Meetup", path: "/service/vivah-meetup" },
    { name: "Advanced Biodata Maker", path: "/service/advanced-biodata-maker" },
  ];
